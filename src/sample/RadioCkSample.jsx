...
const RadioCkSample = ({ preViewState, type, formDataHandle, boxId }) => {
  ...
  useEffect(() => {
    if (preViewState) {
      setRadioCkTitle(storeState.find((v) => v.boxId === boxId).boxTitle);
    }
  }, []);
  ...
  const radioCkTitleChangeHandle = (e) => {
    ...
    formDataHandle("boxTitle", e.target.value, boxId);
  };

  const radioCkEtcTextChangeHandle = (e) => {
    setRadioCkEtcText(e.target.value);
    formDataHandle("etcText", e.target.value, boxId);
  };
  ...
  const checkedChangeHandle = (e, type) => {
    let arr = [...checkedArr];
    if (type === "chkbox") {
      if (e.target.checked) {
    ...
    formDataHandle("boxChecked", arr, boxId);
  };
              ...
              if (v.id === "etc") {
                return (
                  <FormControlLabel
                    ...
                    onChange={(e) => checkedChangeHandle(e, "radio")}
                  />
                );
              } else {
                return (
              ...
              if (v.id === "etc") {
                return (
                  <FormControlLabel
                    ...
                    onChange={(e) => checkedChangeHandle(e, "chkbox")}
                  />
                );
              } else {
                return (
